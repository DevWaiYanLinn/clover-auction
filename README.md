...
-   We plan to separate the backend code from the frontend in the future. Currently, the project's source code is messy because it combines both the frontend and backend. This restructuring will help improve code organization and maintainability. [Api documentation Link](https://clover-auction-backend.onrender.com/swagger) 
